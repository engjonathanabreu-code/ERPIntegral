...
window.ERPMetasV2={render,refresh:render,historyModal,async openDetail(id){document.querySelector('.nav [data-view="metas"]')?.click();await render();metaDetail(id);}};
