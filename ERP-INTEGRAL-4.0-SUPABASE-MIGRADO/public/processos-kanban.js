...
async function openDetail(id){
  ...
  el.querySelector('.modal-body').dataset.collabEntityType='processo';el.querySelector('.modal-body').dataset.collabEntityId=id;document.body.appendChild(el);el.querySelector('[data-close]').onclick=()=>el.remove();el.onclick=e=>{if(e.target===el)el.remove()};
